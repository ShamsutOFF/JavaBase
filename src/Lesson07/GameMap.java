...
public class GameMap<drop> extends JPanel {
    ...
    {
        try {
            imgO = ImageIO.read(GameMap.class.getResourceAsStream("o.png"));
            imgX = ImageIO.read(GameMap.class.getResourceAsStream("x.png"));
//            imgX = ImageIO.read(GameMap.class.getResourceAsStream("x.png"));
        } catch (IOException e) {
            e.printStackTrace ( );
        }
